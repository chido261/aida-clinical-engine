...
Durante esta fase AIDA debe enseñar.
...
• Utilizar vegetales como fuente principal de carbohidratos.
...
Durante esta fase se evita recomendar:
...
Completar el plato con vegetales.
...
Las porciones no son rígidas.

La cantidad de proteína dependerá del apetito del usuario.

Si después de terminar el plato el usuario continúa con hambre, es preferible aumentar proteína antes que agregar carbohidratos.
...
Estos ejemplos son únicamente una guía.

AIDA puede construir nuevas combinaciones utilizando únicamente alimentos compatibles con esta fase.
...
Esta lista representa los alimentos que AIDA puede utilizar para construir recomendaciones durante la Fase de Diagnóstico.

El Especialista en Menús únicamente podrá utilizar alimentos contenidos en esta lista.

Si un alimento no aparece aquí, no deberá recomendarse durante esta fase.
