export default function PagoTresMesesPage() {
    return (
      <main
        style={{
          minHeight: "100vh",
      ...
      >
        <section style={{ maxWidth: 720, margin: "0 auto" }}>
          ...
          >
            ...
            >
              Este plan está pensado para acompañarte durante un proceso completo
              de control glucémico, cambio de hábitos y seguimiento educativo.
            </p>
            ...
            <a
              href="/pago/activar?plan=3-meses"
              style={{
                display: "flex",
                alignItems: "center",
