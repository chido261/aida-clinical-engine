...
import type {
  ...
  export function mapAidaMomentToLegacyMoment(moment: AidaReadingMoment): AidaLegacyMoment {
  ...
  export function buildAidaAdvisorDecision(params: {
    ...
    if (primaryGlucose === null) {
      ...
      if (saysWillWalkAfterPostmeal && hasRecentPostmealElevatedContext) {
        return {
          ...
          reason: "Usuario confirma que hará caminata después de una lectura postcomida elevada.",
        };
      }
    ...
    if (readingMoment === "AYUNO") {
      return {
        ...
        readingMoment,
        detectedSymptoms: symptoms,
        clinicalEvent: primaryGlucose >= 126 ? "FASTING_HIGH" : "FASTING_IN_RANGE",
        nutritionGoal: primaryGlucose >= 126 ? "LOWER_GLUCOSE" : "MAINTAIN_GLUCOSE",
        followUpAction: "NONE",
